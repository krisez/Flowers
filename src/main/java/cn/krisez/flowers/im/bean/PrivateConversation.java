package cn.krisez.flowers.im.bean;
...
import cn.krisez.flowers.im.model.BaseModel;
...
public class PrivateConversation extends Conversation{
    ...
    public PrivateConversation(BmobIMConversation conversation){
        ...
        if (cType == BmobIMConversationType.PRIVATE){
            nickname = conversation.getConversationTitle();
            Log.d("PrivateConversation", "PrivateConversation:" + nickname);
            //cName=conversation.getConversationTitle();
            //if (TextUtils.isEmpty(nickname)) nickname = cId;
        }else{
            nickname="未知会话";
        }
